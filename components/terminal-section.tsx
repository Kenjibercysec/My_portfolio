...
export default function TerminalSection() {
  ...
  const lines = [
    ...
    "silas_kenji",
    "$ cat about.txt",
    "Backend Developer and Software Engineer with strong infrastructure skills,",
    "Experienced in building secure, scalable systems and backend architectures",
    "Background in penetration testing, vulnerability assessment, and security best practices.",
    "$ cat skills.json",
    "{",
